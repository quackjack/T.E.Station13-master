...
/obj/item/clothing/head/helmet/space/hardsuit/security/metrocop
	...
	armor = list("melee" = 60, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 70, "bio" = 100, "rad" = 75, "fire" = 100, "acid" = 100, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor
	...
	armor = list("melee" = 40, "bullet" = 50, "laser" = 45, "energy" = 40, "bomb" = 70, "bio" = 100, "rad" = 5, "fire" = 75, "acid" = 100, "wound" = 30)
