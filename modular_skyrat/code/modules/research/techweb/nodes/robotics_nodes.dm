...
/datum/techweb_node/ipc_construction
	...
	design_ids = list("ipc_chassis", "synthliz_chassis", "synth_chassis", "synth_groin", "ipc_heart", "ipc_lungs", "ipc_tongue", "ipc_stomach", "ipc_liver", "ipc_eyes", "ipc_ears", "cyborg_penis", "cyborg_testicles", "cyborg_breasts", "cyborg_vagina", "cyborg_womb")
